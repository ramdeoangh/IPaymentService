...
namespace PaymentServiceLib.Util
{
    ...
    public class DefaultMessageParser : IMessageParser
    {
        ...
        enum ParameterType
        {
            ClerkParameters=1           ,
            Commsparameters          =2 ,  
            ReceiptsParameters       =3 ,  
            TransOptionParameters    =4 ,  
            TerminalSettingParameters=5 ,  
            SecurityParameters       =6 ,  
            SetupParameters          =7 ,  
            DownloadOnlyParameters   =8 ,  
            AllParameters            =9 ,  
            SemiIntegratedParameters = 10
        }                               
        enum ECRRequestTags           
        {
            
            TransactionAmount = 1, ECRTenderType =2, ClerkID = 3, Invoice=4, AuthCode=4,
            CustomerReference=10,ECRReference=011, PANLAST=12,
            ECRTransTypeClass=13,
            ReprintType=50,
            ParameterType=51,
            RecallTransaction=91
        }
     
        #region StringToEFTResponse
        /// <summary> Parses a string to an TerminalBaseResponse message </summary>
        /// <param name="msg">string to parse</param>
        /// <returns>An TerminalBaseResponse message</returns>
        /// <exception cref="ArgumentException">An ArgumentException is thrown if the contents of msg is invalid</exception>
        public TerminalBaseResponse StringToEFTResponse(string msg)
        {
            if (msg?.Length < 1)
            {
        ...
        T TryParse<T>(string input, int length, ref int index, string format)
        {
            ...
            if (input.Length - index >= length)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        if (result is System.Enum && length == 1)
                            result = (T)System.Enum.ToObject(typeof(T), ((string)data)[0]);
        ...
        TerminalBaseResponse ParseEFTTransactionResponse(string msg)
        {
            var index = 1;
        ...
        TerminalBaseResponse ParseEFTGetLastTransactionResponse(string msg)
        {
            var index = 1;
        ...
        TerminalBaseResponse ParseSetDialogResponse(string msg)
        {
            var index = 1;
        ...
        TerminalBaseResponse ParseEFTLogonResponse(string msg)
        {
            var index = 1;
        ...
        TerminalBaseResponse ParseDisplayResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseReceiptResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseControlPanelResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseEFTReprintReceiptResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseEFTSettlementResponse(string msg)
        {
            var index = 1;
        ...
        TerminalBaseResponse ParseQueryCardResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseClientListResponse(string msg)
        {
        ...
        TerminalBaseResponse ParseEFTConfigureMerchantResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseEFTStatusResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseChequeAuthResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseGenericPOSCommandResponse(string msg)
        {
        ...
        TerminalBaseResponse ParseConfigMerchantResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseCloudLogonResponse(string msg)
        {
            int index = 1;
        ...
        TerminalBaseResponse ParseBasketDataResponse(string msg)
        {
        ...
        /// <summary>
        /// Convert a PaymentTerminal message (e.g. #0010K0000) to a human readable debug string
        /// </summary>
        ...
        public string EFTRequestToString(TerminalBaseRequest eftRequest)
        {
        ...
        StringBuilder BuildRequest(TerminalBaseRequest eftRequest)
        {
            ...
            if (eftRequest is ECRTransactionRequest)
            {
                return BuildECRTransactionRequest((ECRTransactionRequest)eftRequest);
            }
            ...
            throw new Exception("Unknown TerminalBaseRequest type.");
        }

        private StringBuilder BuildECRTransactionRequest(ECRTransactionRequest v)
        {
            var r = new StringBuilder();
            r.Append("M");
            r.Append("0");            
            r.Append(v.TxnType.DescriptionAttr().PadLeft(2));
            r.Append(FS);
            r.Append(((int)ECRRequestTags.TransactionAmount).PadLeft(3));
            r.Append(v.AmtPurchase.PadLeftAsInt(4));

            r.Append(FS);
            r.Append(((int)ECRRequestTags.ECRTenderType).PadLeft(3));
            r.Append(v.tenderType);

            r.Append(FS);
            r.Append(((int)ECRRequestTags.ClerkID).PadLeft(3));
            r.Append(v.Merchant);
            r.Append(FS);
            r.Append(((int)ECRRequestTags.Invoice).PadLeft(3));
            r.Append(v.Invoice);

            r.Append(FS);
            r.Append(((int)ECRRequestTags.AuthCode).PadLeft(3));
            r.Append(v.AuthCode);

            r.Append(FS);
            r.Append(((int)ECRRequestTags.CustomerReference).PadLeft(3));
            r.Append(v.CustomerReference);
        ...
        StringBuilder BuildEFTGetLastTransactionRequest(EFTGetLastTransactionRequest v)
        {
            ...
            r.Append("N");
            r.Append("0");
            r.Append(ECRRequestTags.RecallTransaction);
            r.Append(v.Application.ToApplicationString());
            r.Append(v.Merchant.PadRightAndCut(2));
            r.Append(v.TxnRef.PadRightAndCut(16));
            return r;
        ...
        public TerminalBaseResponse XMLStringToEFTResponse(string msg)
        {
        ...
        public string EFTRequestToXMLString(TerminalBaseRequest eftRequest)
        {
            switch (eftRequest)
            {
