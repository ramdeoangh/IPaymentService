...
namespace PaymentServiceLib.Model
{
	...
	public class EFTGetPasswordRequest : TerminalBaseRequest
	{
	...
	public class EFTGetPasswordResponse : TerminalBaseResponse
	{
    ...
    public class EFTPayAtTableRequest : TerminalBaseRequest
    {
    ...
    public class EFTPayAtTableResponse : TerminalBaseResponse
    {
