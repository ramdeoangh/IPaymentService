...
{
    public  class TerminalGetLastTransactionResponse:TerminalBaseResponse
    {
        /// <summary>Constructs a default terminal transaction response object.</summary>
        public TerminalGetLastTransactionResponse()
            : base(typeof(TerminalGetLastTransactionRequest))
        { }
        ...
        /// <summary>The type of PaymentTerminal transaction that was requested.</summary>
