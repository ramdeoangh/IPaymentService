...
{
    /// <summary>A PaymentTerminal get last transaction response object.</summary>
	public class EFTGetLastTransactionResponse : TerminalBaseResponse
    {
        ...
        /// <summary>The type ofPaymentTerminal transaction that was requested.</summary>
