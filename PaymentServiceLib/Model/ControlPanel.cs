...
{
    /// <summary>Indicates which tabs of the PaymentTerminal Client control panel to display.</summary>
	...
	/// <summary>Indicates when to trigger the <see cref="TerminalClientIP.OnDisplayControlPanel"/> event.</summary>
...
#pragma warning disable CS0618
    /// <summary>A PaymentTerminal show control panel request object.</summary>
...
#pragma warning restore CS0618
    ...
    public class ControlPanelRequest : TerminalBaseRequest
    {
	...
	/// <summary>A PaymentTerminal show control panel response object.</summary>
	public class EFTControlPanelResponse : TerminalBaseResponse
	{
