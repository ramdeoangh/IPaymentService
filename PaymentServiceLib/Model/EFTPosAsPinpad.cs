...
namespace PaymentServiceLib.Model
{
    ...
    /// <summary>
    /// A PaymentTerminal POS as pinpad request object.
    /// </summary>
    [XmlRoot("PCEFTPOS_BRIDGE")]
    public class EFTPosAsPinpadRequest : TerminalBaseRequest
    {
    ...
    /// <summary>
    /// A PaymentTerminal POS as pinpad response object.
    /// </summary>
    [XmlRoot("PCEFTPOS_BRIDGE")]
    public class EFTPosAsPinpadResponse : TerminalBaseResponse
    {
    ...
    public class EntryPoint
    {
        ...
        public EntryPointType EntryPointType
        {
            get
            {
                ...
                {
                    if (System.Enum.TryParse<EntryPointType>(Type, out var type))
                    {
                        entryPointType = type;
                    }
                    else
    ...
    public class Input
    {
        ...
        public InputMode InputModeType { get { return (string.IsNullOrEmpty(InputMode) ? PaymentServiceLib.Model.InputMode.AlphaNumeric : (InputMode)System.Enum.Parse(typeof(InputMode), InputMode)); } }
