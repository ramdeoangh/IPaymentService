...
{
    /// <summary>PaymentTerminal settlement types.</summary>
    ...
    /// <summary>PaymentTerminal settlement card totals data.</summary>
	...
	/// <summary>PaymentTerminal settlement totals data.</summary>
	...
	/// <summary>A PaymentTerminal terminal settlement request object.</summary>
	public class EFTSettlementRequest : TerminalBaseRequest
	{
	...
	/// <summary>A PaymentTerminal terminal settlement response object.</summary>
	public class EFTSettlementResponse : TerminalBaseResponse
	{
